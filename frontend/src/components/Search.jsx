...
const Search = ({onSearch}) => {
  ...
  return (
    <form className='max-w-xl lg:w-10/12 mx-auto p-2 sm:w-72' onSubmit={(e)=>onSearch(e,username)}>
			...
			<div className='relative bg-white rounded-lg'>
				...
				<input
					type='search'
					id='default-search'
					className='block w-full p-4 ps-10 text-md rounded-lg bg-glass focus:ring-blue-500 focus:border-blue-500 bg-transparent focus:bg-transparent text-black'
